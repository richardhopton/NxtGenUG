...
namespace Presenter
{
    internal class Bitmap : UIElement
    {
        ...
        public Bitmap(BitmapSource source) : this()
        {
            Source = source;
        }
        ...
        {
            var bitmap = d as Bitmap;
            if (bitmap != null)
            {
                var oldValue = e.OldValue as BitmapSource;
                var newValue = e.NewValue as BitmapSource;
        ...
        private static Point TryApplyVisualTransform(Point point, Visual v, bool inverse, bool throwOnError,
                                                     out bool success)
        {
            success = true;
            if (v != null)
